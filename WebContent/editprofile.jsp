        ...
        <div id="display_area">
            ...
            <div class="edit_profile">
                ...
                <div class="prof_pic_input">
                    <p><input type="file"  accept="image/*" name="image" id="input_prof_pic_file"  onchange="loadFile(event)" style="display: none; cursor: pointer;"></p>
                    <p><img id="input_prof_pic" width="150px" height="150px" style="border: 1px solid black; border-radius: 75px;" src="images/default_prof_pic.png"/></p>
                    <p><label for="input_prof_pic_file" style="cursor: pointer;">Upload Picture</label></p>
                    <script>
                ...
                <div class="fields_input">
                    ...
                    <input type="text" id="edit_name" value="<%=(user.getName()==null?"":user.getName())%>">

                    <label for="edit_bio" style="display: inline-block; margin-top: 20px;">Bio</label>
                    <textarea id="edit_bio"><%=(user.getBio()==null?"":user.getBio())%></textarea>
                    
                    <label for="edit_email" style="display: inline-block; margin-top: 20px;">Email</label>
                    <input type="email" id="edit_email" value="<%=(user.getEmail()==null?"":user.getEmail())%>" style="width:63%">
                    
                    <label for="edit_contact" style="display: inline-block; margin-top: 20px;">Contact</label>
                    <input type="tel" id="edit_contact" value="<%=(user.getContact()==null?"":user.getContact())%>">

                    <!--EDIT ACHIEVEMENTS-->
                    <div class="edit_achievements">
                        <p style="font-size: 22px; margin: 0; margin-top: 30px;">Achievements
                        ...
                        <%
                			ArrayList<Achievement>achievements=user.getAchievements();
                				...
                				%>
                			<button class="edit_one_achievement_button" id="<%=achievement.getAchievementID()%>">
                                ...
                                <p class="edit_ach_cert" style="font-size: 15px;"><a href="" style="text-decoration:none;">View Certificate</a></p>
                            	</div>
                           	</button>
                    				<%
                				}
                        ...
                        <div id="modal_for_achievement" class="modal_edit_one_achievement">
                            ...
                            <div class="modal-content">
                              ...
                              <div id="form_for_achievements">
                                ...
                                <p style="font-size: 25px;" id="title_edit_ach">Edit Achievement</p>
                                <p style="font-size: 25px; display: none;" id="title_add_ach">Add Achievement</p>
								...
								<input name="ach_image" type="file" onchange="readURL(this)" accept="image/*" id="edit_ach_image_input">
                    ...
                    <div class="edit_internships">
                        <p style="font-size: 22px; margin: 0; margin-top: 30px;">Internships
                	...
                	for(Internship internship : internships){
                   		%>
                            ...
                            <div class="edit_one_internship">
                                ...
                                From&nbsp;: 
                                <p class="edit_int_startdate" style="font-size: 15px; display: inline-block;"><%=internship.getStartDate() %></p>
                                <br>
                                To&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
                                <p class="edit_int_enddate" style="font-size: 15px; display: inline-block;"><%=internship.getEndDate() %></p>
                                <p class="edit_int_description" style="font-size: 15px;"><%=internship.getDescription() %></p>
                                <p class="edit_int_cert" style="font-size: 15px;"><a href="" style="text-decoration:none;">View Certificate</a></p>
                            </div>
                        </button>
                    		<%
                    	}
                        ...
                        <div id="modal_for_internship" class="modal_edit_one_internship">
                            ...
                            <div class="modal-content">
                              ...
                              <div id="form_for_internships">
                                ...
                                <label for="edit_int_name_input">Name</label>
                                <input type="text" id="edit_int_name_input">
                                <label for="edit_int_startdate_input">Start Date</label>
                                <input type="date" id="edit_int_startdate_input">
                                <label for="edit_int_enddate_input">End Date</label>
                                <input type="date" id="edit_int_enddate_input">
                                <label for="edit_int_description_input">Description</label>
                                <textarea id="edit_int_description_input"></textarea>
                                <label for="edit_int_image_input">Attach Image</label>
								<input name="int_image" type="file" onchange="readURL(this)" accept="image/*" id="edit_int_image_input">
                                <div class="modal_buttons">
